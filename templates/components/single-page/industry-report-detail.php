...
$override_button_text = (get_field('override_button_text', $post->ID) != '') ? get_field('override_button_text', $post->ID) : "Download report";
...
$download_link = ($custom_link != '') ? $custom_link : $file['url'];
?>
    ...
    <div class="v-middle-inner container">
      <div class="v-middle">
        <div class="content-wrapper wow fadeIn" data-wow-delay="0.4s">
          ...
          <p><?php print $blurb; ?></p>
          <?php else: ?>
          <p>Thank you for your interest. Enjoy the report.</p>
          <?php endif; ?>
          <a href="<?php print $download_link; ?>" class="btn-white" data-text="<?php print $override_button_text;?>">
