document.addEventListener('DOMContentLoaded', function(event) {
  if(document.getElementById('logo-content-slider') !== null) {
    document.querySelector(".logo-content-slider .slider-for").style.opacity = 1;

    var navLinks = document.querySelectorAll(".logo-content-slider .slider-nav .item a");
    ...
    var secondarySlider = new Splide('#logo-content-slider .slider-outer', {
      rewind: true,
      // fixedWidth: 100,
      // fixedHeight: 64,
      isNavigation: true,
    ...
    var primarySlider = new Splide( '#logo-content-slider .slider-for', {
      type       : 'fade',
      heightRatio: 0.5,
      arrows     : false,
      cover      : true,
